<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="OprAsistencia.aspx.vb" Inherits="attendanceSystemWeb1._0.OprAsistencia" %>
...
<html lang="es">
  <head runat="server">
    ...
    <title>Sistema de Asistencia! | Asistencia</title>
                    ...
                    <br />
                      ...
                      <div class="item form-group">
                        <div class="col-md-6 col-sm-6 offset-md-3">
                          <asp:Button  runat="server" CssClass="btn btn-success" ID="Guardar" Text="Entrada" />
                        </div>
                      </div>
                  </div>
                </div>
